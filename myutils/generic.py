...
def print_tree_structure(directory, omit_dirs=[".venv", ".pytest_cache", "__pycache__", ".git", ".mypy_cache"], prefix=""):
...
def print_file_contents(directory, omit_dirs=[".venv", ".pytest_cache", "__pycache__", ".git", ".mypy_cache"] , max_file_length=None):
